...
int main(int argc, char* argv[]) {
    ...
    std::vector<Metric> metrics = {
        ...
        {"Neuron count",        (double)m.neuron_count,          288.0,  1,  "", ""},  // Step 114: +13 (IL1/IL2 lat, SDQL, RME lat, PDA/B, PVW, CAN)
        {"Synapse count",       (double)m.synapse_count,         681.0,  1,  "", ""},  // Step 114: +10
        {"Gap junction count",  (double)m.gap_junction_count,    240.0,  1,  "", ""},  // Step 114: +6
    };
