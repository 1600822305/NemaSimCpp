...
**效应**: food_memory → AVA 兴奠电流 (+2.5 pA × food_memory)
...
有 ARS 时：虫子 t=100-260s 在食物附近 1.4-5.4mm 振荡，多次接近

| 指标 | 无 ARS | 有 ARS | 说明 |
|------|--------|--------|------|
| time_near_food | ~27% | **51.6%** | 2x ✅ |
| CI (300s) | -1.5 | **0.520** | ✅ |
| reversal_rate | ~0.08/s | 0.21/s | 局部搜索效果 ✅ |
| 最大逃逸距离 | 36mm | ~9mm | 大幅减少 ✅ |
| 食物附近停留 | 80s | >160s | 2x ✅ |
